...
func V(level Level) Verbose {
	...
	case 1:
		return Verbose(zap.S().Level().Enabled(zapcore.WarnLevel))
	default:
		return Verbose(zap.S().Level().Enabled(zapcore.DebugLevel))
	}
}
...
// Infos is a shim
func (v Verbose) InfoS(format string, args ...interface{}) {
	zap.S().Infow(format, args)
}
