	...
	buildSetup := pipelinev1beta1.TaskSpec{
		...
		Steps: []pipelinev1beta1.Step{
			...
			},
			{
				...
				Script: installKeystore(preprocessorArgs),
			},
			{
				Name:            "build",
				Image:           "$(params." + PipelineImage + ")",
			...
			},
			{
				...
				Script: installKeystore(verifyBuiltArtifactsArgs),
			},
			{
				...
				Script: installKeystore(deployArgs),
			},
		},
	}
...
func installKeystore(args []string) string {
