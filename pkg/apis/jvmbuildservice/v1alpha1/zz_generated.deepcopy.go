...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BuildTaskInfo) DeepCopyInto(out *BuildTaskInfo) {
	*out = *in
	if in.Params != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BuildTaskInfo.
func (in *BuildTaskInfo) DeepCopy() *BuildTaskInfo {
	if in == nil {
		return nil
	}
	out := new(BuildTaskInfo)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SystemConfigSpec) DeepCopyInto(out *SystemConfigSpec) {
	*out = *in
	...
	if in.PreBuildTasks != nil {
		in, out := &in.PreBuildTasks, &out.PreBuildTasks
		*out = make([]BuildTaskInfo, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
